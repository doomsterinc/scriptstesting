...
#testa se nao existe elementos incomun
if s1.isdisjoint(s2):
    print("s1 e s2 nao tem elementos em comum!!!")

#dicionarios
livro = {"autor": "J.R.R. Tolkien", "titulo": "O Hobbit"}
print(livro)

livro["saga"] = "Middle-earth"
...
x = input("informe o tamanho do quadrado: ")
x = int(x)
print("o pertimetro do quadrado é ", 4*x)
...
print("o resultado da soma é: ", s1)
...
print (somatoria(1,2,3,4,5,6,7,8,9))
...
def cambio(componente):
    ...
    print(componente[0], "US$ ", componente[1]*3.95)
